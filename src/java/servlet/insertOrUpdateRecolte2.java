 ...
 * @author Yoan
 */
public class insertOrUpdateRecolte2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            try {
                int idRecolte = Integer.parseInt(request.getParameter("idRecolte"));
                ...
                for (int i = 0; i < lp.size(); i++) {
                    ...
                    if (save == 1) {
                        ...
                        String idRecolteParcelleStr = request.getParameter("idRecolteParcelle"+parcelle.getIdParcelle());
                        if(idRecolteParcelleStr != null) {
                            System.out.println("idRecolteParcelleStr "+idRecolteParcelleStr);
                            rp.setIdRecolteParcelle(idRecolteParcelleStr);
                        }
                ...
                recolte.insertOrUpdateRecolteParcelle(null);
                
                recolte = Recolte.getById(idRecolte, null);
